...
This folder contains an active list of 4,278 companies using **Slack**. 
...
We hold verified contact information (emails, phone numbers, decision-maker titles) for **4,278+** companies using Slack.
